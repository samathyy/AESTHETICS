import{_ as B,c as r,b as s,d as b,e as f,h as y,t as l,j as C,x as m,i as g,F as d,g as u,r as w,v as S,o as n,l as c,w as T,f as I}from"./index-C_93pKSu.js";const x={name:"Blogs",data(){return{blogs:[{id:1,title:"Having a website for your business is not a luxury but a necessity",summary:"If you’re still on the fence about creating a website for your small business, it’s time to reconsider. In today’s digital age, having an online presence is essential.",image:"https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80",badge:"WEBSITE",badgeClass:"badge-website",content:`
          ...
          `},{id:6,title:"Web Design Trends for 2025",summary:"Stay ahead of the curve with these top web design trends that will define the digital landscape in 2025.",image:require("../assets/images/ui-ux-representations-with-laptop.jpg"),badge:"TRENDS",badgeClass:"badge-trends",content:`
          ...
          `}],currentPage:1,perPage:3,searchQuery:"",showSuggestions:!1,suggestionIndex:-1,welcomeText:"Welcome to Aesthetics Blog",typedText:"",typingIndex:0,showCursor:!0,typingInterval:null,cursorInterval:null,selectedCategory:"",showFloatBtn:!1}},mounted(){this.startTyping(),this.cursorInterval=setInterval(()=>{this.showCursor=!this.showCursor},500),window.addEventListener("scroll",this.handleScrollFloatBtns)},beforeDestroy(){clearInterval(this.typingInterval),clearInterval(this.cursorInterval),window.removeEventListener("scroll",this.handleScrollFloatBtns)},computed:{categories(){const o=new Set(this.blogs.map(t=>t.badge));return Array.from(o)},totalPages(){return Math.ceil(this.blogs.length/this.perPage)},paginatedBlogs(){const o=(this.currentPage-1)*this.perPage;return this.blogs.slice(o,o+this.perPage)},filteredBlogs(){let o=this.blogs;if(this.selectedCategory&&(o=o.filter(t=>t.badge===this.selectedCategory)),this.searchQuery){const t=this.searchQuery.toLowerCase();o=o.filter(p=>p.title.toLowerCase().includes(t))}return o},paginatedBlogsFiltered(){const o=(this.currentPage-1)*this.perPage;return this.filteredBlogs.slice(o,o+this.perPage)},totalPagesFiltered(){return Math.ceil(this.filteredBlogs.length/this.perPage)||1},filteredSuggestions(){if(!this.searchQuery)return[];const o=this.searchQuery.toLowerCase();return this.blogs.filter(t=>t.title.toLowerCase().includes(o)).slice(0,5)}},methods:{startTyping(){this.typedText="",this.typingIndex=0,this.typingInterval=setInterval(()=>{this.typingIndex<this.welcomeText.length?(this.typedText+=this.welcomeText[this.typingIndex],this.typingIndex++):clearInterval(this.typingInterval)},70)},onSearchInput(){this.showSuggestions=!!this.searchQuery&&this.filteredSuggestions.length>0,this.suggestionIndex=-1,this.currentPage=1},moveSuggestion(o){if(!this.showSuggestions)return;const t=this.filteredSuggestions.length-1;this.suggestionIndex=Math.max(0,Math.min(t,this.suggestionIndex+o))},selectSuggestion(){this.suggestionIndex>=0&&this.filteredSuggestions[this.suggestionIndex]?this.goToBlog(this.filteredSuggestions[this.suggestionIndex].id):this.filteredBlogs.length===1?this.goToBlog(this.filteredBlogs[0].id):this.showSuggestions=!1},goToBlog(o){this.$router.push({name:"BlogDetail",params:{id:o}}),this.showSuggestions=!1},searchBlog(){this.filteredBlogs.length===1?this.goToBlog(this.filteredBlogs[0].id):(this.showSuggestions=!1,this.currentPage=1)},goToPage(o){this.currentPage=o,window.scrollTo({top:0,behavior:"smooth"})},selectCategory(o){this.selectedCategory=o===this.selectedCategory?"":o,this.currentPage=1},handleScrollFloatBtns(){this.showFloatBtn=window.scrollY>200},scrollToTop(){window.scrollTo({top:0,behavior:"smooth"})},goBack(){this.$router.back()}}},P={class:"blogs-section"},q={class:"blog-search-header"},D={class:"blog-welcome"},M={key:0,class:"typing-cursor"},_={class:"search-bar-container"},A={key:0,class:"suggestions-list"},W=["onMousedown"],G={class:"blog-filters"},Y=["onClick"],E={class:"blogs-list"},L={class:"blog-image-block"},R=["src","alt"],F={class:"blog-content"},H={class:"blog-title"},N={class:"blog-summary"},U={class:"pagination"},z=["onClick"],Q={class:"float-back-btn"};function V(o,t,p,K,a,i){const v=w("router-link"),k=w("MainFooter");return n(),r("section",P,[s("div",q,[s("h1",D,[s("span",null,l(a.typedText),1),a.showCursor?(n(),r("span",M,"|")):y("",!0)]),s("div",_,[f(s("input",{"onUpdate:modelValue":t[0]||(t[0]=e=>a.searchQuery=e),onInput:t[1]||(t[1]=(...e)=>i.onSearchInput&&i.onSearchInput(...e)),onKeydown:[t[2]||(t[2]=m(g(e=>i.moveSuggestion(1),["prevent"]),["down"])),t[3]||(t[3]=m(g(e=>i.moveSuggestion(-1),["prevent"]),["up"])),t[4]||(t[4]=m(g((...e)=>i.selectSuggestion&&i.selectSuggestion(...e),["prevent"]),["enter"]))],type:"text",placeholder:"Search Blog",class:"blog-search-input"},null,544),[[C,a.searchQuery]]),s("button",{class:"blog-search-btn",onClick:t[5]||(t[5]=(...e)=>i.searchBlog&&i.searchBlog(...e)),title:"Search Blog"},t[8]||(t[8]=[s("span",{class:"search-icon"},"🔍",-1)])),a.showSuggestions&&i.filteredSuggestions.length?(n(),r("ul",A,[(n(!0),r(d,null,u(i.filteredSuggestions,(e,h)=>(n(),r("li",{key:e.id,class:c({"active-suggestion":h===a.suggestionIndex}),onMousedown:g(O=>i.goToBlog(e.id),["prevent"])},l(e.title),43,W))),128))])):y("",!0)])]),s("div",G,[(n(!0),r(d,null,u(i.categories,e=>(n(),r("button",{key:e,class:c(["filter-btn",{active:a.selectedCategory===e}]),onClick:h=>i.selectCategory(e)},l(e),11,Y))),128)),a.selectedCategory?(n(),r("button",{key:0,class:"filter-btn clear",onClick:t[6]||(t[6]=e=>i.selectCategory(""))},"Clear")):y("",!0)]),s("div",E,[(n(!0),r(d,null,u(i.paginatedBlogsFiltered,e=>(n(),r("div",{class:"blog-card",key:e.id},[s("div",L,[s("img",{src:e.image,alt:e.title,class:"blog-image",loading:"lazy"},null,8,R),s("span",{class:c(["blog-badge",e.badgeClass])},l(e.badge),3)]),s("div",F,[s("h3",H,l(e.title),1),s("p",N,l(e.summary),1),b(v,{to:{name:"BlogDetail",params:{id:e.id}},class:"read-more"},{default:T(()=>t[9]||(t[9]=[I("Read "),s("span",null,"→",-1)])),_:2,__:[9]},1032,["to"])])]))),128))]),s("div",U,[(n(!0),r(d,null,u(i.totalPagesFiltered,e=>(n(),r("button",{key:e,class:c(["page-btn",{active:e===a.currentPage}]),onClick:h=>i.goToPage(e)},l(e),11,z))),128))]),b(k),f(s("div",Q,[s("button",{class:"back-btn",onClick:t[7]||(t[7]=(...e)=>i.goBack&&i.goBack(...e)),title:"Back"},t[10]||(t[10]=[s("svg",{width:"28",height:"28",fill:"none",stroke:"#ffb300","stroke-width":"2.2",viewBox:"0 0 24 24"},[s("path",{d:"M15 19l-7-7 7-7"})],-1)]))],512),[[S,a.showFloatBtn]])])}const J=B(x,[["render",V],["__scopeId","data-v-598d2dd4"]]);export{J as default};
